...
namespace rep.heframework
{
    public class GenStep_LootPerPawn : GenStep
    {
        ...
        public override void Generate(Map map, GenStepParams parms)
        {
            ...
            WorldObjectExtension extension = HEF_Utils.GetWorldObjectExtension(faction.def, parms);
            if (extension == null)
            {
        ...
        public bool PopulateDictionary(Dictionary<ThingDef, int> lootLinkDict, WorldObjectExtension extension)
        {
